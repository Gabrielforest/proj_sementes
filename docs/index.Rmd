...
sheets <- sheets[,c(1,11,13,14,15,24)]

names(sheets) <- c("Nome científico", "Grupo sucessional", "Número de Sementes/kg", "Tamanho da semente", "Taxa de germinação", "Preço selecionado")
...
table1 <- data %>% 
  reactable(
    ...
    columns = list(
      ...
      `Preço selecionado` = colDef(style = color_scales(sheets), format = colFormat(prefix = "R$")),
